...
Dans le fichier **aircraft_type.hpp**, on définit la vitesse maximales et accélération de chaque avion.

**Le Concorde est censé pouvoir voler plus vite que les autres avions. Modifiez le programme pour tenir compte de cela.**
